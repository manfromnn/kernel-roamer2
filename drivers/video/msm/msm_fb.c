...
static int skip_pan_display_cnt=2;
...
static int msm_fb_probe(struct platform_device *pdev)
{
	...
	if ((pdev->id == 0) && (pdev->num_resources > 0)) {
		...
		//fbram = __va(fbram_phys);      //mmu what
...
static int msm_fb_register(struct msm_fb_data_type *mfd)
{
	...
	case MDP_RGB_565:
		...
		var->transp.length = 0;
		bpp = 2;
		printk("The default FB Format is MDP_RGB_565\n ");
		break;
	...
	case MDP_RGB_888:
		...
		var->transp.length = 0;
		bpp = 3;
		printk("The default FB Format is MDP_RGB_888\n ");
		break;
	...
	case MDP_ARGB_8888:
		...
		var->transp.length = 8;
		bpp = 4;		
		printk("The default FB Format is MDP_ARGB_8888\n ");
		break;
	...
	case MDP_RGBA_8888:
		...
		var->transp.length = 8;
		bpp = 4;		
		printk("The default FB Format is MDP_RGBA_8888\n ");
		break;
...
#endif
	ret = 0;
#ifdef CONFIG_FB_MSM_MIPI_LEAD_VIDEO_WVGA_PT
        ...
        char *page, char **start, off_t off, int count, int *eof, void *data)
{
	...
	switch(LcdPanleID)
	{
		...
		case LCD_PANEL_4P0_HX8363_IVO_YUSHUN:
			...
			break;
		case LCD_PANEL_4P0_OTM8018_CMI:
			strcpy(module_name,"zteCMI(OTM8018)_480*800_4.0Inch");
			break;
		...
		case LCD_PANEL_3P5_HX8357_BOE:
			...
			break;	
		case LCD_PANEL_3P5_HX8357C_TRULY_LG:
			strcpy(module_name,"zteTrulyLg(Hx8357c)_320*480_3.5Inch");
			break;
		case LCD_PANEL_3P5_HX8357C_TIANMA:
			strcpy(module_name,"zteTianMa(Hx8357c)_320*480_3.5Inch");
			break;
		case LCD_PANEL_3P5_HX8357_CPT_LEAD:
			strcpy(module_name,"zteLEAD/TRULY/YS(Hx8357)_320*480_3.5Inch");
			break;				
		case LCD_PANEL_3P5_NT35310_TM:
			strcpy(module_name,"zteTM(NT35310)_320*480_3.5Inch");
			break;
		case LCD_PANEL_3P5_NT35310_CMI:
			strcpy(module_name,"zteCMI(NT35310)_320*480_3.5Inch");
			break;
		case LCD_PANEL_MAX:
