...
static char hx8357c_lead_para_0xb1[7]={0xb1, 0x00, 0x14, 0x18, 0x18, 0x85, 0xaa};  
...
static char HX8357C_CPT_para_0xBE[4]=      //关掉uP
{ 
       0xBE,0x00,0x00,0x5A
}; 
static char HX8357C_CPT_para_0xB0[3]=     //以下为手动slp out
{ 
       0xB0,0x66,0x01
}; 

static char HX8357C_CPT_para_0xB1_01[8]= 
{ 
       0xB1,0x00,0x14,0x18,0x18,0x05,0xAA,0x30
}; 
//delay 30ms; 
static char HX8357C_CPT_para_0xB1_02[8]= 
{ 
       0xB1,0x00,0x14,0x18,0x18,0x05,0xAA,0x70
}; 
//delay 10ms; 
static char HX8357C_CPT_para_0xB1_03[8]= 
{ 
       0xB1,0x00,0x14,0x18,0x18,0x85,0xAA,0x50
}; 
//delay 100ms;
...
{
	0xB4,0x02,0x40,0x00,0x2A,0x2A,0x0D,0x4F
};
...
static char HX8357C_CPT_para_0xE0[68]= 
{
	...
	0x00,0x12,0x00,0x25,0x00,0x3b,0x00,0x48,
	0x00,0x4e,0x00,0x4b,0x00,0x45,0x00,0x40,
	0x00,0x38,0x00,0x36,0x00,0x31,0x00,0x31,
	0x00,0x2d,0x01,0x00,0x00,0x04,0x00,0x09,
	0x00,0x12,0x00,0x25,0x00,0x3b,0x00,0x48,
	0x00,0x4e,0x00,0x4b,0x00,0x45,0x00,0x40,
	0x00,0x38,0x00,0x36,0x00,0x31,0x00,0x31,
	0x00,0x2c,0x00,0x00
};
static char HX8357C_CPT_para_0xB2[6]=  //手动display on
{ 
       0xB2,0x00,0x83,0x3B,0x00,0x3C
}; 
//delay 20ms;; 
...
static struct dsi_cmd_desc HX8357C_CPT_display_on_cmds[] = 
{
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(HX8357C_CPT_para_0xBE), HX8357C_CPT_para_0xBE},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(HX8357C_CPT_para_0xB0), HX8357C_CPT_para_0xB0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 30, sizeof(HX8357C_CPT_para_0xB1_01), HX8357C_CPT_para_0xB1_01},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 10, sizeof(HX8357C_CPT_para_0xB1_02), HX8357C_CPT_para_0xB1_02},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 100, sizeof(HX8357C_CPT_para_0xB1_03), HX8357C_CPT_para_0xB1_03},
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 20, sizeof(HX8357C_CPT_para_0xB2), HX8357C_CPT_para_0xB2},
	//{DTYPE_DCS_WRITE, 1, 0, 0, 150, sizeof(HX8357C_CPT_para_0x11), HX8357C_CPT_para_0x11},
	//{DTYPE_DCS_WRITE, 1, 0, 0, 5, sizeof(HX8357C_CPT_para_0x29), HX8357C_CPT_para_0x29},
...
static char boe_hx8357c_para01[]={0xB9,0xFF,0x83,0x57};
static char boe_hx8357c_para02[]={0xCC,0x05};
static char boe_hx8357c_para03[]={0xB6,0x54};
static char boe_hx8357c_parab3[]={0xB3,0x43,0x00,0x06,0x06};
static char boe_hx8357c_para04[]={0xB1,0x00,0x13,0x12,0x12,0x83,0xAA};
static char boe_hx8357c_para05[]={0xB4,0x01,0x40,0x00,0x2A,0x2A,0x0D,0x4F};
static char boe_hx8357c_para06[]={0xC0,0x24,0x50,0x01,0x3C,0xC8,0x08};
static char boe_hx8357c_para07[]={0xE0,0x00,0x00,0x00,0x00,0x0B,0x00,0x10,
									0x00,0x25,0x00,0x29,0x00,0x41,0x00,0x4B,
									0x00,0x54,0x00,0x46,0x00,0x3F,0x00,0x3B,
									0x00,0x31,0x00,0x30,0x00,0x27,0x00,0x28,
									0x00,0x07,0x01,0x00,0x00,0x0B,0x00,0x10,
									0x00,0x25,0x00,0x29,0x00,0x41,0x00,0x4B,
									0x00,0x54,0x00,0x46,0x00,0x3F,0x00,0x3B,
									0x00,0x31,0x00,0x30,0x00,0x27,0x00,0x28,
									0x00,0x07,0x00,0x00
								  };												
//static char boe_hx8357c_para08[]={0x35,0x00};
//static char boe_hx8357c_para09[]={0xB0,0x68};
static char boe_hx8357c_para10[]={0xBA,0x00,0x56,0xD4,0x00,0x0A,0x00,0x10,
									0x32,0x6E,0x04,0x05,0x9A,0x14,0x19,0x10,
									0x40
								 };						
static char boe_hx8357c_para11[]={0x3A,0x70};
static char boe_hx8357c_para12[]={0xE9,0x20};
static char boe_hx8357c_para13[]={0x11,0x00};
static char boe_hx8357c_para14[]={0x29,0x00};

static struct dsi_cmd_desc hx8357c_boe_display_on_cmds[] = { 
                                                            
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para01), boe_hx8357c_para01},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para02), boe_hx8357c_para02},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para03), boe_hx8357c_para03},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_parab3), boe_hx8357c_parab3},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para04), boe_hx8357c_para04},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para05), boe_hx8357c_para05},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para06), boe_hx8357c_para06},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para07), boe_hx8357c_para07},
//{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para08), boe_hx8357c_para08},
//{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para09), boe_hx8357c_para09},
{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para10), boe_hx8357c_para10},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para11), boe_hx8357c_para11},
{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(boe_hx8357c_para12), boe_hx8357c_para12},
{DTYPE_DCS_WRITE, 1, 0, 0, 120, sizeof(boe_hx8357c_para13), boe_hx8357c_para13},
{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(boe_hx8357c_para14), boe_hx8357c_para14}, 
...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	{	
		...
		case (u32)LCD_PANEL_3P5_HX8357_BOE:
			mipi_dsi_cmds_tx(mfd, &lead_tx_buf, hx8357c_boe_display_on_cmds, ARRAY_SIZE(hx8357c_boe_display_on_cmds));
...
{	
	...
	if (LcdPanleID ==LCD_PANEL_3P5_NT35310_TM)//this panel is different from others
	{
