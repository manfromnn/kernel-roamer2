...
2010-12-14   wly         v9ƒ¨»œ ˙∆¡                                 ZTE_WLY_CRDB00586327
...
struct atmel_config_data atmel_data = {
	...
	.config_T22_charge[0]=0x09,//t22[0]
#endif
...
#elif defined(CONFIG_MACH_ROAMER2)||defined(CONFIG_MACH_DEEPBLUE)//for N766/V766 N790
		struct atmel_config_data atmel_data = {
		.version = 0x16,
		.source = 1,
		.abs_x_min = 0,
...
#ifdef CONFIG_ATMEL_TS_NOTIFIER
			.config_T9_charge[0] = 70,//58,//10	 //t9[7]
			.config_T9_charge[1] = 0,//10	  //t9[31]
			.config_T9_charge[2] = 10,//10	//t9[11]
			.config_T9_charge[3] = 10,//10	//t9[12]
			.config_T28_charge[0] = 20,//0x0a
			.config_T28_charge[1] = 20,//0x0a	
			//.config_T22_charge[0]=0x09,//t22[0]
