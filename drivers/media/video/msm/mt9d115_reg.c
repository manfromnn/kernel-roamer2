...
#if defined(CONFIG_MACH_MOONCAKE2) || defined(CONFIG_MACH_ROAMER2)
...
{0x099C, 0xBDFD,WORD_LEN,0},
{0x099E, 0x033B,WORD_LEN,0},
{0x098C, 0x0445,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xCC06,WORD_LEN,0},
{0x0992, 0x6BFD,WORD_LEN,0},
{0x0994, 0x032F,WORD_LEN,0},
{0x0996, 0xCC03,WORD_LEN,0},
{0x0998, 0x25DD,WORD_LEN,0},
{0x099A, 0x5DC6,WORD_LEN,0},
{0x099C, 0x1ED7,WORD_LEN,0},
{0x099E, 0x6CD7,WORD_LEN,0},
{0x098C, 0x0455,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x6D5F,WORD_LEN,0},
{0x0992, 0xD76E,WORD_LEN,0},
{0x0994, 0xD78D,WORD_LEN,0},
{0x0996, 0x8620,WORD_LEN,0},
{0x0998, 0x977A,WORD_LEN,0},
{0x099A, 0xD77B,WORD_LEN,0},
{0x099C, 0x979A,WORD_LEN,0},
{0x099E, 0xC621,WORD_LEN,0},
{0x098C, 0x0465,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xD79B,WORD_LEN,0},
{0x0992, 0xFE01,WORD_LEN,0},
{0x0994, 0x6918,WORD_LEN,0},
{0x0996, 0xCE03,WORD_LEN,0},
{0x0998, 0x4DCC,WORD_LEN,0},
{0x099A, 0x0013,WORD_LEN,0},
{0x099C, 0xBDC2,WORD_LEN,0},
{0x099E, 0xB8CC,WORD_LEN,0},
{0x098C, 0x0475,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x05E9,WORD_LEN,0},
{0x0992, 0xFD03,WORD_LEN,0},
{0x0994, 0x4FCC,WORD_LEN,0},
{0x0996, 0x034D,WORD_LEN,0},
{0x0998, 0xFD01,WORD_LEN,0},
{0x099A, 0x69FE,WORD_LEN,0},
{0x099C, 0x02BD,WORD_LEN,0},
{0x099E, 0x18CE,WORD_LEN,0},
{0x098C, 0x0485,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x0361,WORD_LEN,0},
{0x0992, 0xCC00,WORD_LEN,0},
{0x0994, 0x11BD,WORD_LEN,0},
{0x0996, 0xC2B8,WORD_LEN,0},
{0x0998, 0xCC06,WORD_LEN,0},
{0x099A, 0x28FD,WORD_LEN,0},
{0x099C, 0x036F,WORD_LEN,0},
{0x099E, 0xCC03,WORD_LEN,0},
{0x098C, 0x0495,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x61FD,WORD_LEN,0},
{0x0992, 0x02BD,WORD_LEN,0},
{0x0994, 0xDE00,WORD_LEN,0},
{0x0996, 0x18CE,WORD_LEN,0},
{0x0998, 0x00C2,WORD_LEN,0},
{0x099A, 0xCC00,WORD_LEN,0},
{0x099C, 0x37BD,WORD_LEN,0},
{0x099E, 0xC2B8,WORD_LEN,0},
{0x098C, 0x04A5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xCC06,WORD_LEN,0},
{0x0992, 0x4FDD,WORD_LEN,0},
{0x0994, 0xE6CC,WORD_LEN,0},
{0x0996, 0x00C2,WORD_LEN,0},
{0x0998, 0xDD00,WORD_LEN,0},
{0x099A, 0xC601,WORD_LEN,0},
{0x099C, 0xF701,WORD_LEN,0},
{0x099E, 0x64C6,WORD_LEN,0},
{0x098C, 0x04B5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x05F7,WORD_LEN,0},
{0x0992, 0x0165,WORD_LEN,0},
{0x0994, 0x7F01,WORD_LEN,0},
{0x0996, 0x6639,WORD_LEN,0},
{0x0998, 0x373C,WORD_LEN,0},
{0x099A, 0x3C3C,WORD_LEN,0},
{0x099C, 0x3C3C,WORD_LEN,0},
{0x099E, 0x30EC,WORD_LEN,0},
{0x098C, 0x04C5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x11ED,WORD_LEN,0},
{0x0992, 0x02EC,WORD_LEN,0},
{0x0994, 0x0FED,WORD_LEN,0},
{0x0996, 0x008F,WORD_LEN,0},
{0x0998, 0x30ED,WORD_LEN,0},
{0x099A, 0x04EC,WORD_LEN,0},
{0x099C, 0x0DEE,WORD_LEN,0},
{0x099E, 0x04BD,WORD_LEN,0},
{0x098C, 0x04D5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xA406,WORD_LEN,0},
{0x0992, 0x30EC,WORD_LEN,0},
{0x0994, 0x02ED,WORD_LEN,0},
{0x0996, 0x06FC,WORD_LEN,0},
{0x0998, 0x10C0,WORD_LEN,0},
{0x099A, 0x2705,WORD_LEN,0},
{0x099C, 0xCCFF,WORD_LEN,0},
{0x099E, 0xFFED,WORD_LEN,0},
{0x098C, 0x04E5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x06F6,WORD_LEN,0},
{0x0992, 0x0256,WORD_LEN,0},
{0x0994, 0x8616,WORD_LEN,0},
{0x0996, 0x3DC3,WORD_LEN,0},
{0x0998, 0x0261,WORD_LEN,0},
{0x099A, 0x8FE6,WORD_LEN,0},
{0x099C, 0x09C4,WORD_LEN,0},
{0x099E, 0x07C1,WORD_LEN,0},
{0x098C, 0x04F5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x0226,WORD_LEN,0},
{0x0992, 0x1DFC,WORD_LEN,0},
{0x0994, 0x10C2,WORD_LEN,0},
{0x0996, 0x30ED,WORD_LEN,0},
{0x0998, 0x02FC,WORD_LEN,0},
{0x099A, 0x10C0,WORD_LEN,0},
{0x099C, 0xED00,WORD_LEN,0},
{0x099E, 0xC602,WORD_LEN,0},
{0x098C, 0x0505,WORD_LEN,0},     // MCU_ADDRESS
...
{0x099E, 0x201B,WORD_LEN,0},
{0x098C, 0x0515,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xFC10,WORD_LEN,0},
{0x0992, 0xC230,WORD_LEN,0},
{0x0994, 0xED02,WORD_LEN,0},
{0x0996, 0xFC10,WORD_LEN,0},
{0x0998, 0xC0ED,WORD_LEN,0},
{0x099A, 0x00C6,WORD_LEN,0},
{0x099C, 0x01BD,WORD_LEN,0},
{0x099E, 0xC253,WORD_LEN,0},
{0x098C, 0x0525,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x30EC,WORD_LEN,0},
{0x0992, 0x00FD,WORD_LEN,0},
{0x0994, 0x10C0,WORD_LEN,0},
{0x0996, 0xEC02,WORD_LEN,0},
{0x0998, 0xFD10,WORD_LEN,0},
{0x099A, 0xC2C6,WORD_LEN,0},
{0x099C, 0x80D7,WORD_LEN,0},
{0x099E, 0x85C6,WORD_LEN,0},
{0x098C, 0x0535,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x40F7,WORD_LEN,0},
{0x0992, 0x10C4,WORD_LEN,0},
{0x0994, 0xF602,WORD_LEN,0},
{0x0996, 0x5686,WORD_LEN,0},
{0x0998, 0x163D,WORD_LEN,0},
{0x099A, 0xC302,WORD_LEN,0},
{0x099C, 0x618F,WORD_LEN,0},
{0x099E, 0xEC14,WORD_LEN,0},
{0x098C, 0x0545,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xFD10,WORD_LEN,0},
{0x0992, 0xC501,WORD_LEN,0},
{0x0994, 0x0101,WORD_LEN,0},
{0x0996, 0x0101,WORD_LEN,0},
{0x0998, 0xFC10,WORD_LEN,0},
{0x099A, 0xC2DD,WORD_LEN,0},
{0x099C, 0x7FFC,WORD_LEN,0},
{0x099E, 0x10C7,WORD_LEN,0},
{0x098C, 0x0555,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xDD76,WORD_LEN,0},
{0x0992, 0xF602,WORD_LEN,0},
{0x0994, 0x5686,WORD_LEN,0},
{0x0996, 0x163D,WORD_LEN,0},
{0x0998, 0xC302,WORD_LEN,0},
{0x099A, 0x618F,WORD_LEN,0},
{0x099C, 0xEC14,WORD_LEN,0},
{0x099E, 0x939F,WORD_LEN,0},
{0x098C, 0x0565,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x30ED,WORD_LEN,0},
{0x0992, 0x08DC,WORD_LEN,0},
{0x0994, 0x7693,WORD_LEN,0},
{0x0996, 0x9D25,WORD_LEN,0},
{0x0998, 0x08F6,WORD_LEN,0},
{0x099A, 0x02BC,WORD_LEN,0},
{0x099C, 0x4F93,WORD_LEN,0},
{0x099E, 0x7F23,WORD_LEN,0},
{0x098C, 0x0575,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x3DF6,WORD_LEN,0},
{0x0992, 0x02BC,WORD_LEN,0},
{0x0994, 0x4F93,WORD_LEN,0},
{0x0996, 0x7F23,WORD_LEN,0},
{0x0998, 0x06F6,WORD_LEN,0},
{0x099A, 0x02BC,WORD_LEN,0},
{0x099C, 0x4FDD,WORD_LEN,0},
{0x099E, 0x7FDC,WORD_LEN,0},
{0x098C, 0x0585,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x9DDD,WORD_LEN,0},
{0x0992, 0x76F6,WORD_LEN,0},
{0x0994, 0x02BC,WORD_LEN,0},
{0x0996, 0x4F93,WORD_LEN,0},
{0x0998, 0x7F26,WORD_LEN,0},
{0x099A, 0x0FE6,WORD_LEN,0},
{0x099C, 0x0AC1,WORD_LEN,0},
{0x099E, 0x0226,WORD_LEN,0},
{0x098C, 0x0595,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x09D6,WORD_LEN,0},
{0x0992, 0x85C1,WORD_LEN,0},
{0x0994, 0x8026,WORD_LEN,0},
{0x0996, 0x0314,WORD_LEN,0},
{0x0998, 0x7401,WORD_LEN,0},
{0x099A, 0xF602,WORD_LEN,0},
{0x099C, 0xBC4F,WORD_LEN,0},
{0x099E, 0x937F,WORD_LEN,0},
{0x098C, 0x05A5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x2416,WORD_LEN,0},
{0x0992, 0xDE7F,WORD_LEN,0},
{0x0994, 0x09DF,WORD_LEN,0},
{0x0996, 0x7F30,WORD_LEN,0},
{0x0998, 0xEC08,WORD_LEN,0},
{0x099A, 0xDD76,WORD_LEN,0},
{0x099C, 0x200A,WORD_LEN,0},
{0x099E, 0xDC76,WORD_LEN,0},
{0x098C, 0x05B5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xA308,WORD_LEN,0},
{0x0992, 0x2304,WORD_LEN,0},
{0x0994, 0xEC08,WORD_LEN,0},
{0x0996, 0xDD76,WORD_LEN,0},
{0x0998, 0x1274,WORD_LEN,0},
{0x099A, 0x0122,WORD_LEN,0},
{0x099C, 0xDE5D,WORD_LEN,0},
{0x099E, 0xEE14,WORD_LEN,0},
{0x098C, 0x05C5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xAD00,WORD_LEN,0},
{0x0992, 0x30ED,WORD_LEN,0},
{0x0994, 0x11EC,WORD_LEN,0},
{0x0996, 0x06ED,WORD_LEN,0},
{0x0998, 0x02CC,WORD_LEN,0},
{0x099A, 0x0080,WORD_LEN,0},
{0x099C, 0xED00,WORD_LEN,0},
{0x099E, 0x8F30,WORD_LEN,0},
{0x098C, 0x05D5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0xED04,WORD_LEN,0},
{0x0992, 0xEC11,WORD_LEN,0},
{0x0994, 0xEE04,WORD_LEN,0},
{0x0996, 0xBDA4,WORD_LEN,0},
{0x0998, 0x0630,WORD_LEN,0},
{0x099A, 0xE603,WORD_LEN,0},
{0x099C, 0xD785,WORD_LEN,0},
{0x099E, 0x30C6,WORD_LEN,0},
{0x098C, 0x05E5,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x0B3A,WORD_LEN,0},
...
{0x099C, 0xB059,WORD_LEN,0},
{0x099E, 0xCC00,WORD_LEN,0},
{0x098C, 0x0655,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x28BD,WORD_LEN,0},
{0x0992, 0xA558,WORD_LEN,0},
{0x0994, 0x8300,WORD_LEN,0},
{0x0996, 0x0027,WORD_LEN,0},
...
{0x099C, 0x30ED,WORD_LEN,0},
{0x099E, 0x00C6,WORD_LEN,0},
{0x098C, 0x0665,WORD_LEN,0},     // MCU_ADDRESS
{0x0990, 0x03BD,WORD_LEN,0},
{0x0992, 0xA544,WORD_LEN,0},
{0x0994, 0x3839,WORD_LEN,0},
{0x0996, 0xBDD9,WORD_LEN,0},
{0x0998, 0x42D6,WORD_LEN,0},
{0x099A, 0x9ACB,WORD_LEN,0},
{0x099C, 0x01D7,WORD_LEN,0},
{0x099E, 0x9B39,WORD_LEN,0},
{0x098C, 0x2006,WORD_LEN,0},     // MCU_ADDRESS [MON_ARG1]
{0x0990, 0x0415,WORD_LEN,0},      // MCU_DATA_0
{0x098C, 0xA005,WORD_LEN,0},     // MCU_ADDRESS [MON_CMD]
...
//[Gamma 0.5]
	...
	//add by lijing to decrease blue 20130124
...
static struct mt9d115_i2c_reg_conf const sharpness_tbl_2[] = {    
    {0x098C, 0xAB22, WORD_LEN, 0}, 	// MCU_ADDRESS [HG_LL_APCORR1]
    {0x0990, 0x0004, WORD_LEN, 0}, 	// MCU_DATA_0 //0x07
};
