...
#endif
#ifdef CONFIG_TOUCHSCREEN_MXT224//ZTE_TS_XYM_20110808
#include <linux/atmel_qt602240.h>
extern struct atmel_i2c_platform_data atmel_data;
#endif
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C
#include <linux/input/synaptics_rmi4_i2c.h> //ZTE_TS_XYM_20110905
#endif
			...
			struct device_attribute *attr, char *buf)
{
	...
	return sprintf(
		buf,__stringify(EV_KEY) ":" __stringify(KEY_MENU) ":40:850:60:60"
		":" __stringify(EV_KEY) ":" __stringify(KEY_HOME) ":170:850:60:60"
		":" __stringify(EV_KEY) ":" __stringify(KEY_BACK) ":300:850:60:60"
...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_RMI4_I2C
{
		I2C_BOARD_INFO("synaptics-rmi4-ts", 0x22 ),
...
//#endif
	...
	i2c_register_board_info(MSM_GSBI1_QUP_I2C_BUS_ID,
		i2c_touch_devices,
		ARRAY_SIZE(i2c_touch_devices));//XYM
#if 0	
