...
#if 0   //BEGIN.  modified by zhang.yu_1 for removing moto power @20120101
...
#endif   //END.  modified by zhang.yu_1 for removing moto power @20120101
            mdelay(500);
...
//ZTE_CAM_LJ_20120425 change mclk drv current from 2MA to 8MA
...
#ifdef CONFIG_OV2675
static struct msm_camera_sensor_platform_info ov2675_sensor_7627a_info = {
	.mount_angle = 90
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov2675_data = {
	...
	.sensor_platform_info   = &ov2675_sensor_7627a_info,
	.csi_if                 = 1
};

static struct platform_device msm_camera_sensor_ov2675 = {
...
static struct i2c_board_info i2c_camera_devices[] = {
	...
	#ifdef CONFIG_MT9D115
	{
       #if defined(CONFIG_MACH_ATLAS40) ||defined(CONFIG_MACH_SEANPLUS)
		I2C_BOARD_INFO("mt9d115", 0x78 >> 2),
	#else
		I2C_BOARD_INFO("mt9d115", 0x7A >> 1),
	#endif
	},
	#endif
	{
